...
- `packages/site-gmail/src/gmail-api.ts` — Gmail API client (OAuth2 auth, label fetch, label-query message ID fetch with beforeDate support for gap-fill, scope-based message search, search query builder)
